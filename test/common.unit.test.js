...
describe("isSecured", () => {
  test("Is a secure payload", () => {
    expect(
      isSecured("sha1=5d61605c3feea9799210ddcb71307d4ba264225f", {}, "secret")
    ).toBe(true)
  })
...
describe("getRepositoryFiles", () => {
      ...
      .reply(200, [
        {
          ...
          git_url:
            "https://api.github.com/repos/dobladov/testTTL/git/blobs/f304ffef3df045061daf7700503d7cdd79cbc040",
          download_url:
            "https://raw.githubusercontent.com/dobladov/testTTL/master/esc.ttl",
          type: "file",
          _links: {
        ...
        },
        {
          ...
          html_url:
            "https://github.com/dobladov/testTTL/blob/master/hochschulfaecher.ttl",
          git_url:
            "https://api.github.com/repos/dobladov/testTTL/git/blobs/7f59f2e2fe0ff7f5d8a90a23949fcc1d053f726f",
          download_url:
            "https://raw.githubusercontent.com/dobladov/testTTL/master/hochschulfaecher.ttl",
          type: "file",
          _links: {
  ...
  test("Should return the valid file for the given type skohub", async () => {
    nock("http://localhost:6000")
      .get("/getFiles")
      .reply(200, [
        { path: "esc.ttl", url: "http://localhost:6000/download/esc.ttl" },
      ])
